<?php
namespace Module\Instagram;

use Illuminate\Support\ServiceProvider;
use Illuminate\Routing\Router;
use Module\Main\BaseServiceProvider;

class InstagramServiceProvider extends BaseServiceProvider
{
	protected $namespace = 'Module\Instagram\Http\Controllers';
	...
	public function register(){
		...
		$this->loadViewsFrom(realpath(__DIR__."/Views"), 'instagram');
