...
Route::get('setting/maintenance', 'SettingController@maintenance')->name('admin.maintenance.index');
Route::post('setting/maintenance', 'SettingController@postMaintenance')->name('admin.maintenance.maintenance');
