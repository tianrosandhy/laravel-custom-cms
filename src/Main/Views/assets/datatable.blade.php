<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/jquery.dataTables.js') !!}"></script>
<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js') !!}"></script>
<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/extensions/export/buttons.html5.min.js') !!}"></script>
<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/extensions/export/buttons.flash.min.js') !!}"></script>
<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/extensions/export/jszip.min.js') !!}"></script>
<script type="text/javascript" src="{!! admin_asset('assets/plugins/jquery-datatable/extensions/export/pdfmake.min.js') !!}"></script>
<script>
var tb_data;
$(function(){
